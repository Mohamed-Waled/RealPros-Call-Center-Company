            ...
            <div className={classes.outer}>
              <div className={classes.card} data-aos="slide-right">
                <div className={classes.info}>
                  ...
                  <p>
                    ...
                    estate database on the market. PropStream puts the power of
                    data & investor tools you need to pull targeted lists
              ...
              <div className={classes.card} data-aos="slide-left">
                <div className={classes.info}>
                  ...
                  <p>
                    Simple yet powerful dialer that includes numerous workflows
                    for different sales call tasks, such as nurturing warm
                    leads, while allowing your Professional Caller to auto-dial
                    up to one-hundred calls per hour.
                  </p>
                </div>
              </div>
              <div className={classes.card} data-aos="slide-right">
                <div className={classes.info}>
                  ...
                  <p>
                    Manage the wholesale lead process by organizing and tracking
                    your deals inputted by your Quality Manager on the daily
                    basis. After your leads are in the system, all you would
                    have to do is follow up and take your deals to the finish
                    line.
                  </p>
                </div>
              </div>
